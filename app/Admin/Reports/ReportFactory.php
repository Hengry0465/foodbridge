...
use App\Admin\Reports\Decorators\PickupStatusFilterDecorator;
...
class ReportFactory
{
    public function make(ReportFilterDto $filters): ReportInterface
    {
        ...
        if ($filters->status !== null) {
            $report = $filters->type === ReportType::Pickups
                ? new PickupStatusFilterDecorator($report, $filters->status)
                : new StatusFilterDecorator($report, $filters->status);
        }

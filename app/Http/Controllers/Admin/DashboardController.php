    ...
    public function index(
        ...
        return view('admin.dashboard', [
            ...
            'counts' => [
                ...
                'matches' => DonationMatch::query()->count(),
            ...
            'donationStatuses' => DonationStatus::cases(),
            'requestStatuses' => FoodRequestStatus::cases(),
            'matchStatuses' => MatchStatus::cases(),
            'pickupStatuses' => PickupStatus::cases(),
            'foodCategories' => FoodCategory::cases(),
            'foodRegions' => FoodRegion::cases(),

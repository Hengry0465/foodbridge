 ...
 <body class="w-full bg-white">
  <header class="w-full">
   <nav class="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
    ...
    <a href="{{ route('login') }}" class="px-8 py-3.5 rounded-full font-semibold text-lg transition hover:scale-105 inline-block bg-emerald-700 text-white hover:bg-emerald-800">
      Get Started</a>
   </nav>
   <section class="relative w-full overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-6 py-32 md:py-44 text-center text-white">
     ...
     <a href="{{ route('login') }}" class="px-5 py-2.5 rounded-full font-medium transition hover:opacity-90 inline-block bg-white text-emerald-800">
      Join FoodBridge</a>
    </div>
   </section>
  </header>

...
<head>
  ...
  <title>FoodShare | Edit Profile</title>
  ...
  <style>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .readonly-tile .value{font-size:0.95rem;font-weight:600;color:var(--text);word-break:break-word}
    .readonly-tile .value.capitalize{text-transform:capitalize}
    .readonly-notice{
    ...
    .password-cta{
      ...
      background:#FAFAF9;border:1.5px solid var(--line);
    ...
    .password-cta-body{display:flex;flex-direction:column;gap:2px;flex:1;min-width:0}
    .password-cta-title{font-weight:600;font-size:0.92rem;color:var(--text)}
    .password-cta-sub{font-size:0.78rem;color:var(--muted)}
    .password-cta-arrow{color:var(--muted);transition:all var(--transition-fast);flex-shrink:0}
    .password-cta:hover .password-cta-arrow{color:var(--primary-dark);transform:translateX(2px)}
    ...
    <section class="profile-form-card">
      <form method="POST" action="{{ route('profile.update') }}" id="profileForm" novalidate>
        ...
        <div class="form-section">
          ...
          <p class="section-subtitle">These fields are managed for security reasons and cannot be self-edited.</p>
          ...
          <div class="readonly-notice">
            ...
            <span>To change your email or role, please contact support. This restriction helps protect your account.</span>
          </div>
          ...
          <a href="{{ route('profile.password.form') }}" class="password-cta">
            ...
            <span class="password-cta-body">
              ...
              <span class="password-cta-sub">You'll need to enter your current password to confirm.</span>
            </span>
            <svg class="password-cta-arrow" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="form-actions">
          <a href="{{ route('donor.dashboard') }}" class="cancel-link">Cancel</a>
  ...
  <script>
    ...
    (function () {
      ...
      form.addEventListener('submit', function () {
        ...
        setTimeout(function () { btn.disabled = false; text.textContent = 'Save changes'; }, 5000);
      });

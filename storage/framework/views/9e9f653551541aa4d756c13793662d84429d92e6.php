        ...
        <table class="w-full text-left">
          ...
          <tbody class="divide-y divide-gray-100">
            <?php $__currentLoopData = $reservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td class="px-5 py-4">
                  <p class="font-semibold"><?php echo e($reservation->donation->food_name); ?></p>
                  <p class="text-xs text-gray-400"><?php echo e($reservation->donation->pickup_address); ?></p>
                </td>
                <td class="px-5 py-4">
                  <?php echo e($reservation->recipient->name ?? 'Unknown Recipient'); ?>

                </td>
                <td class="px-5 py-4">
                  <?php echo e($reservation->quantity_reserved); ?> <?php echo e($reservation->donation->unit); ?>

                </td>
                <td class="px-5 py-4">
                  <span class="tag-<?php echo e($reservation->status); ?> inline-block px-3 py-1 rounded-full text-xs font-semibold">
                    <?php echo e(ucfirst($reservation->status)); ?>

                  </span>
                </td>
                <td class="px-5 py-4 text-sm text-gray-500">
                  <?php echo e($reservation->reserved_at->format('d M Y, h:i A')); ?>
...
</html><?php /**PATH C:\xampp\htdocs\Donation Management\resources\views/donor/history.blade.php ENDPATH**/ ?>
  ...
  <header class="w-full">
   ...
   <section class="relative w-full overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-6 py-32 md:py-44 text-center text-white">
     ...
     <a href="{{ route('donor.dashboard') }}" data-template-id="nav-cta" class="canva-button px-5 py-2.5 rounded-full font-medium transition hover:opacity-90 inline-block">
      Join FoodBridge</a>
    </div>
   </section>
  </header>
